...
//初期化処理
	...
	for(int i= 0;i<TIMEBG_MAX;i++)
	{
		...
		pVtx[0+(4*i)].col = D3DCOLOR_RGBA(255, 255, 255,255 );	//頂点情報格納ワーク
		pVtx[1+(4*i)].col = D3DCOLOR_RGBA(255, 255, 255, 255);
		pVtx[2+(4*i)].col = D3DCOLOR_RGBA(255, 255, 255, 255);
		pVtx[3+(4*i)].col = D3DCOLOR_RGBA(255, 255, 255, 255);
		}
