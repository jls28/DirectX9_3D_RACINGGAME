...
HRESULT InitPause( void )
{
	...
	for( int nCntPause = 0; nCntPause < PAUSE_MENU_MAX; nCntPause++, pVtx+=4)
	{
		//ポーズの位置の初期化
		...
		//4頂点座標のX Y Zの初期化
		pVtx[ 0 ].pos.x = g_aPause[ nCntPause ].pos.x - PAUSE_WIDTH * 0.50f;
		pVtx[ 0 ].pos.y = g_aPause[ nCntPause ].pos.y - PAUSE_HEIGHT * 0.50f;
		pVtx[ 0 ].pos.z = 0.0f;

		pVtx[ 1 ].pos.x = g_aPause[ nCntPause ].pos.x + PAUSE_WIDTH * 0.50f;
		pVtx[ 1 ].pos.y = g_aPause[ nCntPause ].pos.y - PAUSE_HEIGHT * 0.50f;
		pVtx[ 1 ].pos.z = 0.0f;

		pVtx[ 2 ].pos.x = g_aPause[ nCntPause ].pos.x - PAUSE_WIDTH * 0.50f;
		pVtx[ 2 ].pos.y = g_aPause[ nCntPause ].pos.y + PAUSE_HEIGHT * 0.50f;
		pVtx[ 2 ].pos.z = 0.0f;

		pVtx[ 3 ].pos.x = g_aPause[ nCntPause ].pos.x + PAUSE_WIDTH * 0.50f;
		pVtx[ 3 ].pos.y = g_aPause[ nCntPause ].pos.y + PAUSE_HEIGHT * 0.50f;
		pVtx[ 3 ].pos.z = 0.0f;
...
{
	if(g_PauseCheck.bPauseUse ==  true)
	{
	VERTEX_2D *pVtx;
