...
*******************************************************************************/
#ifndef	_MODELARML_H_
#define	_MODELARML_H_

/*******************************************************************************
* マクロ定義
*******************************************************************************/
#define MAX_MODELARML ( 1 )                     // モデルの数

#define POSMOVE_MODELARML	(    5.0f )		// 移動量
...
typedef struct
{
	LPDIRECT3DTEXTURE9 pTextureModelarmL;       // テクスチャへのポインタ
	LPD3DXBUFFER pBuffMatModelarmL;             // 頂点バッファへのポインタ
	LPD3DXMESH pMeshModelarmL;                  // メッシュの情報
	DWORD nNumMatModelarmL;                     // マテリアル数
	D3DXMATRIX mtxWorldModelarmL;               // ワールドマトリックス
