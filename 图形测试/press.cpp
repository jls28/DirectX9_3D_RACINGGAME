...
HRESULT InitPress(void)
{
	...
	D3DXCreateTextureFromFile(
		...
		Press[3].rhw = 1.0f;
		//頂点色設定
		Press[0].col = D3DCOLOR_RGBA(255, 255, 255, 255);	//頂点情報格納ワーク
		Press[1].col = D3DCOLOR_RGBA(255, 255, 255, 255);
		Press[2].col = D3DCOLOR_RGBA(255, 255, 255, 255);
		Press[3].col = D3DCOLOR_RGBA(255, 255, 255, 255);
